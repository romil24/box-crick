...
const SwitcherThree = ({ enabled, onChange }: any) => {
  return (
    <div>
      <label
        htmlFor="toggle3"
      ...
      >
        <div className="relative">
          <input
            ...
            id="toggle3"
            className="sr-only"
            checked={enabled} // Set checked to the enabled prop value
            onChange={() => onChange(!enabled)} // Trigger onChange callback when toggled
          />
